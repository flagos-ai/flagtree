...
cache.store(
    file="liblaunch_shared.so", condition=("xpu" == flagtree_backend) and (configs.flagtree_plugin == ''), url=
    "https://baai-cp-web.ks3-cn-beijing.ksyuncs.com/trans/xpu-liblaunch_shared_so-ubuntu-x64_v0.3.0.tar.gz",
