...
static inline uint32_t hipApiIdByName(const char *name) {
  ...
  if (strcmp("hipGetErrorString", name) == 0)
...
// 'hGraph'), ('const hipGraphNode_t*', 'dependencies'), ('size_t',
// 'numDependencies'), ('const HIP_MEMSET_NODE_PARAMS*', 'memsetParams'),
// ('hipCtx_t', 'ctx')]
...
// hipMemcpyHtoD[('hipDeviceptr_t', 'dst'), ('void*', 'src'), ('size_t',
// 'sizeBytes')]
...
// hipMemcpyHtoDAsync[('hipDeviceptr_t', 'dst'), ('void*', 'src'), ('size_t',
// 'sizeBytes'), ('hipStream_t', 'stream')]
...
static inline void hipApiArgsInit(hip_api_id_t id, hip_api_data_t *data) {
  ...
  case HIP_API_ID_hipDrvGraphAddMemcpyNode:
    ...
    // ('hipGraph_t', 'hGraph'), ('const hipGraphNode_t*', 'dependencies'),
    // ('size_t', 'numDependencies'), ('const HIP_MEMSET_NODE_PARAMS*',
