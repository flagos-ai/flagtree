...
def test_normalization_with_remat():
    ...
    buf14 = torch.rand(8, 32, 64, 64, device="gcu")
    buf16 = torch.rand(8, 1, 32, device="gcu")
    arg114_1 = torch.rand(32, device="gcu")
    arg115_1 = torch.rand(32, device="gcu")
    arg8_1 = torch.rand(32, device="gcu")
    arg9_1 = torch.rand(32, device="gcu")
    triton_[(256,)](buf14, buf16, arg114_1, arg115_1, arg8_1, arg9_1, 256, 4096, 1, 2048, num_warps=4)
...
def test_avg_pool_bw():
    ...
    inp = torch.ones(8, 2048, 8, 8, device="gcu", dtype=torch.half)
    out = torch.ones_like(inp) * 3
    numel = inp.numel()
    triton_[(numel // 1024,)](inp, out, 1024, num_warps=1)
