...
def check_cuda_or_hip(device):
    ...
    if device not in ['cuda']:
        pytest.skip("Not supported on gcu: CUDA is not supported on gcu")
...
# ]
scan_layouts = [
    BlockedLayout([1, 4], [1, THREADS_PER_WARP], [4, 1], [0, 1], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([4, 1], [1, THREADS_PER_WARP], [1, 4], [0, 1], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([2, 2], [1, THREADS_PER_WARP], [2, 2], [0, 1], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([1, 4], [1, THREADS_PER_WARP], [4, 1], [1, 0], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([4, 1], [1, THREADS_PER_WARP], [1, 4], [1, 0], [1, 1], [1, 1], [0, 1]),
...
layouts = [
    # BlockedLayout([1, 4], [8, THREADS_PER_WARP // 8], [4, 1], [1, 0], [1, 1], [1, 1], [0, 1]),
    # BlockedLayout([1, 4], [8, THREADS_PER_WARP // 8], [4, 1], [0, 1], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([1, 4], [1, THREADS_PER_WARP // 1], [4, 1], [1, 0], [1, 1], [1, 1], [0, 1]),
    BlockedLayout([1, 4], [1, THREADS_PER_WARP // 1], [4, 1], [0, 1], [1, 1], [1, 1], [0, 1]),
...
def test_reduce_layouts(M, N, src_layout, axis, epilogue_kind, dtype_str, add_overflow_check, reduce_op, device,
    ...
    blocked = BlockedLayout([1, 1], [1, THREADS_PER_WARP], [4, 1], [0, 1], [1, 1], [1, 1], [0, 1])
...
layouts = [
    ...
    BlockedLayout([1, 4], [THREADS_PER_WARP, 1], [1, 4], [1, 0], [1, 1], [1, 1], [0, 1]),
...
def test_trans_4d(dtype_str, shape, perm, device):
    ...
    ## Just support bf16,fp16,fp32,i32 data type in topsAtenArrang
    # input = torch.arange(math.prod(shape), dtype=getattr(torch, dtype_str), device=device).reshape(shape)
...
def test_dot(M, N, K, num_warps, col_a, col_b, epilogue, input_precision, in_dtype, out_dtype, kpack, mma_nonk_size,
    ...
    # Workaround: gcu400 does not support fp64 type
...
layouts = [
    ...
    BlockedLayout([1, 16], [1, THREADS_PER_WARP], [4, 1], [1, 0], [1, 1], [1, 1], [0, 1]),
    MmaLayout([3, 0], [4, 1], [1, 1], [1, 1], [1, 0], [16, 32, 16]),
    DotOperandLayout(parent=MmaLayout([3, 0], [4, 1], [1, 1], [1, 1], [1, 0], [16, 32, 16]), op_idx=0, k_width=2),
