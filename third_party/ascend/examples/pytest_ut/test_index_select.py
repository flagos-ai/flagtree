...
def test_index_select(src_shape, dim, indice_shape, dtype):
    ...
    @triton.jit
    def basic_index_select(in_ptr, indices_ptr, out_ptr, dim, g_stride: tl.constexpr, indice_length: tl.constexpr,
        ...
        for goffs in range(0, g_block, g_block_sub):
            ...
            for other_offset in range(0, g_stride, other_block):
                ...
                for i in range(0, g_block_sub):
                    ...
                    tmp_buf = tl.insert_slice(tmp_buf, val[None, :], offsets=(i, 0), sizes=(1, other_block),
                                              strides=(g_stride, 1))
    ...
    def triton_func(x0, dim, indices):
        ...
        if g_stride * 2 < available_ub_space:
            ...
            g_block_sub = 1
        basic_index_select[num_vec_core, 1,
